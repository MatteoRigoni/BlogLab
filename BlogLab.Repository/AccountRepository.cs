...
namespace BlogLab.Repository
{
    public class AccountRepository : IAccountRepository
    {
        ...
        public async Task<IdentityResult> CrateASync(ApplicationUserIdentity user, CancellationToken cancellationToken)
        {
        ...
        public async Task<ApplicationUserIdentity> GetByUsernameAsync(string normalizedUsername, CancellationToken cancellationToken)
        {
            ...
            {
                await connection.OpenAsync(cancellationToken);
                applicationUser = connection.QueryFirstOrDefault<ApplicationUserIdentity>(
